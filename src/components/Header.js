...
import ytLogo from "../youtube_lite/images/yt-logo.png";
import ytLogoMobile from "../youtube_lite/images/yt-logo-mobile.png";
...
const Header = () => {
  ...
  return (
    <div className="sticky z-10 top-0 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black ">
      {loading && <Loader />}
